              ...
              <div class="navbar-cart">
                ...
                <div class="cart-items">
                  <a href="javascript:void(0)" class="main-btn">
                    ...
                    <span class="total-items">{{ totalCartProducts.length }}</span>
                  </a>
          ...
          <div class="nav-inner">
            ...
            <div class="mega-category-menu">
              ...
              <ul class="sub-category">
                <li v-for="(category, item) in category" :key="item">
                  <router-link :to="{name:'category', params:{'id': category.id}}">{{ category.name }} <i class="lni lni-chevron-right"></i></router-link>
                  <ul class="inner-sub-category">
                    <li v-for="(subCategory, item) in category.subCategory" :key="item"><a href="product-grids.html">{{subCategory.name}}</a></li>
                  </ul>
                </li>
              </ul>
            </div>
...
export default {
  ...
  methods: {
      getallCategory(){
        axios.get("http://localhost:8000/api/get-category-product").then((response) => {
    ...
    logout(){
      ...
      axios.get("http://localhost:8000/api/customer-logout", data).then((response) => {
