          ...
          <div class="product-grids-head">
            ...
            <div class="tab-content" id="nav-tabContent">
              <div class="tab-pane fade show active" id="nav-grid" role="tabpanel" aria-labelledby="nav-grid-tab">
                <div class="row">
                  <div class="col-lg-4 col-md-6 col-12" v-for="(product,item) in products" :key="item">
...
export default {
  ...
  methods: {
    getAllproduct(){
      axios.get("http://localhost:8000/api/get-category-product-bi-id/"+this.id).then((response) => {
